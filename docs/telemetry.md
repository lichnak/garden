...
Below you can find examples for each one of the events we currently collect.

**Note:** events are batched before being sent to our data processor. This means you shouldn't worry about Garden making dozens of HTTP requests and affecting commands performance.
